...
module PostsControllerExtends
  ...
  included do
    ...
    def create
      ...
      Decidim::Blogs::CreatePost.call(@form, current_user) do
        on(:ok) do
    ...
    def edit
      ...
      @form = form(Decidim::Blogs::PostForm).from_model(post)
    end
    ...
    def update
      ...
      Decidim::Blogs::UpdatePost.call(@form, post, current_user) do
        on(:ok) do
    ...
    def post
      @post ||= Decidim::Blogs::Post.find_by(component: current_component, id: params[:id])
    end
  end
end
